...
export const GlobalStyle = createGlobalStyle`
  ...
  * {
  ...
  /* MDEditor 暗色支持 */
  .w-md-editor {
    --wmd-editor-bg-color: var(--bg-primary);
    --wmd-editor-text-color: var(--text-primary);
    --wmd-editor-border-color: var(--border-color);
  ...
  [data-theme='dark'] .w-md-editor-toolbar li button:hover {
    background: var(--bg-tertiary) !important;
    color: var(--text-primary) !important;
  }

  [data-theme='dark'] .w-md-editor-toolbar li button.active {
    background: var(--bg-tertiary) !important;
  ...
  [data-theme='dark'] .w-md-editor-text-input > textarea {
    background: transparent !important;
    color: var(--text-primary) !important;
  }

  [data-theme='dark'] .w-md-editor-text-input > textarea::placeholder {
    color: var(--text-tertiary) !important;
  }

  /* 分隔栏 */
  [data-theme='dark'] .w-md-editor-toolbar-child {
    border-color: var(--border-color) !important;
  }
